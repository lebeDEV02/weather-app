...
export const generalRequestDispatch = (payload: object) => ({ type: GENERAL_REQUEST, payload })
export const additionalRequestDispatch = (payload: object) => ({ type: ADDITIONAL_REQUEST, payload })